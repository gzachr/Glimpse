...
object DataHelper {
    ...
    fun loadReactionData(): ArrayList<Reaction> {
        ...
        data.add(
            Reaction(
                R.drawable.post1, "user2", "1"
            )
        )
        data.add(
            Reaction(
                R.drawable.post9, "user3", "1"
            )
        )
        data.add(
            Reaction(
                R.drawable.post9, "user7", "1"
            )
        )
        data.add(
            Reaction(
                R.drawable.post6, "user10", "2"
            )
        )
        data.add(
            Reaction(
                R.drawable.post6, "user8", "3"
            )
        )
        data.add(
            Reaction(
                R.drawable.post1, "user4", "3"
            )
        )
        data.add(
            Reaction(
                R.drawable.post6, "user5", "3"
            )
        )
        data.add(
            Reaction(
                R.drawable.post9, "user8", "4"
            )
        )
        data.add(
            Reaction(
                R.drawable.post1, "user3", "4"
            )
        )
